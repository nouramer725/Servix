...
class ResetPasswordDialogWhite extends StatefulWidget {
  @override
  _ResetPasswordDialogWhiteState createState() =>
      _ResetPasswordDialogWhiteState();
}

class _ResetPasswordDialogWhiteState extends State<ResetPasswordDialogWhite> {
