  ...
  Future<Offer> _createOfferWithRating(DocumentSnapshot offerDoc) async {
    ...
    if (technicianDoc.exists) {
      ...
      return Offer(
        ...
        technicianSub: offer.technicianSub,
        technicianMain: offer.technicianMain,
        technicianDescription: offer.technicianDescription,
        technicianLinkSocialMedia: offer.technicianLinkSocialMedia,
        technicianLocationArea: offer.technicianLocationArea,
        technicianLocationStreet: offer.technicianLocationStreet,
        technicianOffer: offer.technicianOffer,
        offer: offer.offer,
        street: offer.street,
        area: offer.area,
        rating: offer.rating,
