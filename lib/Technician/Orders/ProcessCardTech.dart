...
import 'package:servix/Technician/Orders/DetailsScreen/Details_Process.dart';
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => DetailsProcessTech(orders: orders)));
        },
        child: Container(
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) =>
                                        DetailsProcessTech(orders: orders)));
                          },
                          child: const Icon(
